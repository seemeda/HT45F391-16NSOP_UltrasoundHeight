...
L_TRANSMIT_DATA:
	...
	;;MOVF	   MP0,OFFSET __BUFF_DATA;;TEST-
	MOVF	   MP0,OFFSET  __R_DATA;;TEST+
	;;MOVF    __R_TEMP2 , 5;8;12 ;;TEST-
	MOVF      __R_TEMP2 , 10;;TEST+
$0:
    CLR     WDT
	MOVF	RX_DATA,IAR0 
	CALL	SBR_UART_SND
...
;======================================================
    ...
    ;;MOVF   __BUFF_DATA[4] , R_TEMPERATURE_L   ;;TEST-
    MOVF   __BUFF_DATA[4] , __R_TIME_H
    MOVF   __BUFF_DATA[5] , __R_TIME_L   
    MOVF   __BUFF_DATA[6] , R_TEMPERATURE_L
