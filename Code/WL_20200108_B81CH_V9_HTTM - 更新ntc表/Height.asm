...
;    MOVF   __BUFF_DATA[4] , R_TEMPERATURE_H
    MOVF   __BUFF_DATA[4] , R_TEMPERATURE_L
;    MOVF   __BUFF_DATA[6] , __R_SOUND_SPEED_L
    MOVF   __BUFF_DATA[5] , R_RES_DISCHARGE_TIME_H
    MOVF   __BUFF_DATA[6] , R_RES_DISCHARGE_TIME_L
...
MY_CALC_DISTANCE:
	...
	MOVF	__R_TEMP6,03H         
	MOVF	__R_TEMP7,0DH	;;3‭4E20H = 200000‬	
	MOVF	__R_TEMP8,40H       
...
TM0_external_setting:
	...
	MOVF	TM0AL,200 ;10  ;10 100K  200  2M 
	MOVF	TM0AH,0
