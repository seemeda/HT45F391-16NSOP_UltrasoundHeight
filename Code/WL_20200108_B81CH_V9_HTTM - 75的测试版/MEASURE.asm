...
measure		.SECTION	AT	3F0H	'CODE';3F0H
__SBR_SYS_INIT:
;;--------------------------------------------
...
ELSE
	...
	;;TEST++
;	MOVF	__R_SOUND_SPEED_H,HIGH(34844)	;TEST+
;	MOVF	__R_SOUND_SPEED_L,LOW(34844)	;TEST+
